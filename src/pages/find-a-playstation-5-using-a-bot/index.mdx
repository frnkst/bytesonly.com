...
import  ps5NotAvailable from './ps5-not-available.png'
import available from './ps5-available.png'


export const meta = {
  title: 'Find a playstation 5 using a python bot',
  description: 'Find a playstation 5 using a python bot',
  date: '2022-02-18T19:00:00.000Z',
  authors: [frank],
  //image: card,
  footer: `
    <p>
...
<a href={ps5NotAvailable}>
  <img src={ps5NotAvailable} alt="" />
</a>
