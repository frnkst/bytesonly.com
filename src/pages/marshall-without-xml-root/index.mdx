...
export const meta = {
  title: 'Marshall @XmlType annotated java object to a string (without @XmlRoot)',
  description: 'Marshall @XmlType annotated java object to a string (without @XmlRoot)',
